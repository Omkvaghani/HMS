...
class RoomClassController extends Controller
{
    ...
    private function validateData(Request $request, ?RoomClass $existing = null): array
    {
        ...
        return $request->validate([
            ...
            'duration_prices.1H' => ['nullable', 'numeric', 'min:0'],
            'duration_prices.2H' => ['nullable', 'numeric', 'min:0'],
            'duration_prices.3H' => ['nullable', 'numeric', 'min:0'],
            'duration_prices.12H' => ['nullable', 'numeric', 'min:0'],
            'duration_prices.NIGHT' => ['nullable', 'numeric', 'min:0'],
